...
#ifndef RACING_OBSTACLE_DETECTION_PARSER_H
#define RACING_OBSTACLE_DETECTION_PARSER_H
...
extern float score_threshold_;
extern float nms_threshold_;
extern int nms_top_k_;
...
#endif //RACING_OBSTACLE_DETECTION_PARSER_H